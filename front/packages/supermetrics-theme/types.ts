 ...
 */
interface SupermetricsTheme extends Package {
  /**
  ...
  actions: {
    ...
    theme: {
       ...
       */
      toggleMobileMenu: Action<SupermetricsTheme>;

      /**
       * Closes the mobile menu, not matter the previous state.
       */
      closeMobileMenu: Action<SupermetricsTheme>;
    };
  };
...
export default SupermetricsTheme;
